...
public class EndpointHit {
    ...
    public EndpointHit timestamp(LocalDateTime timestamp) {
     ...
     */
    @Valid
    @Schema(name = "timestamp", description = "Дата и время, когда был совершен запрос к эндпоинту (в формате \"yyyy-MM-dd HH:mm:ss\")", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
